<template>
  <div class="screen">
    ...
    <div class="right">
      <h1 id="clock">Clock Out</h1>
      <p id="subtitle">Enter your correct details and submit to clock out</p>
      ...
      <button id="button" @click="clockOut">Submit</button>
    </div>
  </div>
</template>
    ...
    async clockOut() {
      try {
        ...
        const response = await axios.post(
          "http://127.0.0.1:8000/api/clock-out/",
